...
* **Files:** [`parkinsons_telometry_python_and_sql.py`](./parkinsons_telemetry_python_and_sql.py), [`Parkinsons-Telemonitoring-ucirvine.csv`](./Parkinsons-Telemonitoring-ucirvine.csv)
* **Pipeline Workflow:**
